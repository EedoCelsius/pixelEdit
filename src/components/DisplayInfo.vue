<template>
  <div class="flex items-center gap-3 text-sm px-3 py-2">
    <div>원본: <span class="text-slate-200">{{ stageStore.stage.width }}×{{ stageStore.stage.height }}</span></div>
    <div>확대: <span class="text-slate-200">{{ stageStore.stage.scale }}x</span></div>
